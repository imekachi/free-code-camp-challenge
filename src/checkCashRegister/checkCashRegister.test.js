...
describe('checkCashRegister', () => {
  ...
  it('should return status: "OPEN" case 1', () => {
    const result = checkCashRegister(19.5, 20, [
      ['PENNY', 1.01],
      ['NICKEL', 2.05],
      ['DIME', 3.1],
  ...
  it('should return status: "OPEN" case 2', () => {
  ...
  it('should return status: "INSUFFICIENT_FUNDS" case 1', () => {
    const result = checkCashRegister(19.5, 20, [
      ['PENNY', 0.01],
      ['NICKEL', 0],
      ['DIME', 0],
  ...
  it('should return status: "INSUFFICIENT_FUNDS" case 2', () => {
    const result = checkCashRegister(19.5, 20, [
      ['PENNY', 0.01],
      ['NICKEL', 0],
      ['DIME', 0],
